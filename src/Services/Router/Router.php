...
namespace Core\Services\Router {
    ...
    class Router
    {
        ...
        /**
         * Store a before middleware route and a handling function to be executed when accessed using one of the
         * specified methods.
         *
        ...
        /**
         * Execute the router: Loop all defined before middleware's and routes, and execute the handling function if a
         * match was found.
         *
         * @param object|callable $callback Function to be executed after a matching route was handled (= after router
         *                                  middleware)
         *
         * @return bool
         */
        ...
        {
            if ( ! namespace_exists($namespace, __CLASS__) ) {
                self::setStatusCode(HTTP_INTERNAL_SERVER_ERROR);
            }
