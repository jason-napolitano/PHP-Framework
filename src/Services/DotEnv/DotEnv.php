...
namespace Core\Services\DotEnv {

    // IMPORTS ----------------------------------------------------------------
    use Exceptions\InvalidArgumentException;
    use Exceptions\FileSystem\FileNotReadableException;
     ...
     *
     * @package Core\Services\DotEnv
     * @author  CodeIgniter Development Team
     */
    class DotEnv implements \Stringable
    {
        /**
        ...
        protected function parse(): ?array
        {
            ...
            if ( ! is_readable($this->path) ) {
                throw new FileNotReadableException("The .env file is not readable: {$this->path}");
            }
        ...
        /**
         * __toString() method for the Stringable interface
         *
         * @return string
         */
